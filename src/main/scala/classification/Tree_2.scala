...
object Tree_2 {
  def main(args: Array[String]): Unit = {
    val conf = new SparkConf().setAppName("tree_2").setMaster("local")
    ...
    val male = pattern("/Users/wangjx/data/male.txt",1)
    val female = pattern("/Users/wangjx/data/female.txt",2)
